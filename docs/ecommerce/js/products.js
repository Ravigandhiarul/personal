...
const cannabisProducts = [
  // FLOWER PRODUCTS
  {
    ...
    category: "Flower",
    isBaseVariant: true,
    imageUrl: "../images/products/blue-dream.png",
    isFavourite: false,
    quantity: 1,
    isAddedtoCart: false,
    price: 35.00,
  ...
  },
  {
    ...
    name: "Purple Kush",
    category: "Flower",
    imageUrl: "../images/products/purple-kush.webp",
    isFavourite: false,
    quantity: 1,
    isAddedtoCart: false,
    price: 38.00,
  ...
  },
  {
    ...
    name: "Sour Diesel",
    category: "Flower",
    imageUrl: "../images/products/sour-diesel.webp",
    isFavourite: false,
    quantity: 1,
    isAddedtoCart: false,
    price: 40.00,
  ...
  },
  {
    ...
    name: "OG Kush",
    category: "Flower",
    imageUrl: "../images/products/og-kush.webp",
    isFavourite: true,
    quantity: 1,
    isAddedtoCart: false,
    price: 42.00,
  ...
  },
  {
    ...
    category: "Flower",
    imageUrl: "../images/products/girl-scout-cookies.webp",
    isFavourite: false,
    quantity: 1,
    isAddedtoCart: false,
    price: 45.00,
  ...
  },
  {
    ...
    name: "Jack Herer",
    category: "Flower",
    imageUrl: "../images/products/jack-herer.png",
    isFavourite: false,
    quantity: 1,
    isAddedtoCart: true,
    price: 41.00,
  ...
  },
  {
    ...
    name: "White Widow",
    category: "Flower",
    imageUrl: "../images/products/white-widow.png",
    isFavourite: false,
    quantity: 1,
    isAddedtoCart: false,
    price: 37.00,
  ...
  // EDIBLES
  {
    ...
    category: "Edibles",
    imageUrl: "../images/products/cannabis-gummies-mixed-fruit.webp",
    isFavourite: false,
    quantity: 1,
    isAddedtoCart: false,
    price: 25.00,
  ...
  },
  {
    ...
    category: "Edibles",
    imageUrl: "../images/products/chocolate-bar-dark-chocolate.webp",
    isFavourite: false,
    quantity: 1,
    isAddedtoCart: false,
    price: 28.00,
  ...
  },
  {
    ...
    category: "Edibles",
    imageUrl: "../images/products/hard-candies-assorted.webp",
    isFavourite: false,
    quantity: 1,
    isAddedtoCart: false,
    price: 22.00,
  ...
  },
  {
    ...
    category: "Edibles",
    imageUrl: "../images/products/cookies-double-chocolate.jpg",
    isFavourite: true,
    quantity: 1,
    isAddedtoCart: false,
    price: 30.00,
  ...
  // VAPES
  {
    ...
    category: "Vapes",
    imageUrl: "../images/products/vape-cartridge-blue-dream.png",
    isFavourite: false,
    quantity: 1,
    isAddedtoCart: false,
    price: 45.00,
  ...
  },
  {
    ...
    category: "Vapes",
    imageUrl: "../images/products/disposable-vape-sour-diesel.png",
    isFavourite: false,
    quantity: 1,
    isAddedtoCart: false,
    price: 35.00,
  ...
  },
  {
    ...
    category: "Vapes",
    imageUrl: "../images/products/live-resin-cart-wedding-cake.png",
    isFavourite: false,
    quantity: 1,
    isAddedtoCart: false,
    price: 55.00,
  ...
  // CONCENTRATES
  {
    ...
    imageUrl: "../images/products/shatter-lemon-haze.webp",
    isFavourite: false,
    quantity: 1,
    isAddedtoCart: false,
    price: 40.00,
  ...
  },
  {
    ...
    category: "Concentrates",
    imageUrl: "../images/products/wax-purple-punch.png",
    isFavourite: false,
    quantity: 1,
    isAddedtoCart: false,
    price: 42.00,
  ...
  },
  {
    ...
    category: "Concentrates",
    imageUrl: "../images/products/live-rosin-zkittlez.png",
    isFavourite: true,
    quantity: 1,
    isAddedtoCart: true,
    price: 65.00,
  ...
  // PRE-ROLLS
  {
    ...
    category: "Pre-Rolls",
    imageUrl: "../images/products/pre-roll-og-kush.png",
    isFavourite: false,
    quantity: 1,
    isAddedtoCart: false,
    price: 12.00,
  ...
  },
  {
    ...
    category: "Pre-Rolls",
    imageUrl: "../images/products/pre-roll-pack-sativa-mix.png",
    isFavourite: false,
    quantity: 1,
    isAddedtoCart: false,
    price: 45.00,
