...
export function NavBar({ items, className, navItem }: NavBarProps) {
  ...
  return (
    <div
      className={cn(
        "fixed bottom-0 min-[1025px]:top-0 left-1/2 -translate-x-1/2 z-50 mb-6 min-[1025px]:pt-10 h-fit sm:px-[20px]",
        className,
      )}
    >
          ...
          return (
            ...
            >
              ...
              {isActive && (
                ...
                >
                  <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-8 h-1 bg-[#377DFF] rounded-t-full">
